...
import com.github.bobofans.hbtrip.framework.common.validation.InEnum;
import com.github.bobofans.hbtrip.module.bpm.enums.definition.BpmModelFormTypeEnum;
import com.github.bobofans.hbtrip.module.bpm.enums.definition.BpmModelTypeEnum;
 ...
 *
 * 最终，它的字段和 {@link com.github.bobofans.hbtrip.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO} 是一致的
 *
 * @author 芋道源码
 */
@Data
public class BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iocoder.cn/hbtrip.jpg")
