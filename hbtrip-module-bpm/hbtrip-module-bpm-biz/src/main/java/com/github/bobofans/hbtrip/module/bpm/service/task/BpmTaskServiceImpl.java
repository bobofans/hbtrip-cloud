package com.github.bobofans.hbtrip.module.bpm.service.task;
...
import com.github.bobofans.hbtrip.framework.common.util.number.NumberUtils;
import com.github.bobofans.hbtrip.framework.common.util.object.ObjectUtils;
import com.github.bobofans.hbtrip.framework.common.util.object.PageUtils;
import com.github.bobofans.hbtrip.framework.web.core.util.WebFrameworkUtils;
import com.github.bobofans.hbtrip.module.bpm.controller.admin.task.vo.task.*;
import com.github.bobofans.hbtrip.module.bpm.convert.task.BpmTaskConvert;
import com.github.bobofans.hbtrip.module.bpm.enums.definition.*;
import com.github.bobofans.hbtrip.module.bpm.enums.task.BpmCommentTypeEnum;
import com.github.bobofans.hbtrip.module.bpm.enums.task.BpmReasonEnum;
import com.github.bobofans.hbtrip.module.bpm.enums.task.BpmTaskSignTypeEnum;
import com.github.bobofans.hbtrip.module.bpm.enums.task.BpmTaskStatusEnum;
import com.github.bobofans.hbtrip.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.github.bobofans.hbtrip.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.github.bobofans.hbtrip.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.github.bobofans.hbtrip.module.bpm.service.definition.BpmModelService;
import com.github.bobofans.hbtrip.module.bpm.service.message.BpmMessageService;
import com.github.bobofans.hbtrip.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static com.github.bobofans.hbtrip.framework.common.util.collection.CollectionUtils.*;
import static com.github.bobofans.hbtrip.module.bpm.enums.ErrorCodeConstants.*;
import static com.github.bobofans.hbtrip.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 hbtrip-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
