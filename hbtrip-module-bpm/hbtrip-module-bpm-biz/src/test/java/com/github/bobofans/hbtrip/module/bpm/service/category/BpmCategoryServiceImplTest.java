package com.github.bobofans.hbtrip.module.bpm.service.category;
...
import com.github.bobofans.hbtrip.framework.test.core.ut.BaseDbUnitTest;
import com.github.bobofans.hbtrip.module.bpm.controller.admin.definition.vo.category.BpmCategoryPageReqVO;
import com.github.bobofans.hbtrip.module.bpm.controller.admin.definition.vo.category.BpmCategorySaveReqVO;
import com.github.bobofans.hbtrip.module.bpm.dal.dataobject.definition.BpmCategoryDO;
import com.github.bobofans.hbtrip.module.bpm.dal.mysql.category.BpmCategoryMapper;
import com.github.bobofans.hbtrip.module.bpm.service.definition.BpmCategoryServiceImpl;
import jakarta.annotation.Resource;
import org.junit.jupiter.api.Test;
import org.springframework.context.annotation.Import;

import static com.github.bobofans.hbtrip.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.github.bobofans.hbtrip.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.github.bobofans.hbtrip.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.github.bobofans.hbtrip.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.github.bobofans.hbtrip.framework.test.core.util.AssertUtils.assertServiceException;
import static com.github.bobofans.hbtrip.framework.test.core.util.RandomUtils.*;
import static com.github.bobofans.hbtrip.module.bpm.enums.ErrorCodeConstants.CATEGORY_NOT_EXISTS;
