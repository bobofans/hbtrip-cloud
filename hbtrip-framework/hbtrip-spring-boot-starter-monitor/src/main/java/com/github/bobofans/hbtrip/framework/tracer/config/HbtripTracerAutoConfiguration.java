...
import com.github.bobofans.hbtrip.framework.tracer.core.aop.BizTraceAspect;
import com.github.bobofans.hbtrip.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "hbtrip.tracer", value = "enable", matchIfMissing = true)
public class HbtripTracerAutoConfiguration {
