package com.github.bobofans.hbtrip.framework.ai.core.factory;
...
import com.github.bobofans.hbtrip.framework.ai.config.HbtripAiAutoConfiguration;
import com.github.bobofans.hbtrip.framework.ai.config.HbtripAiProperties;
...
import com.github.bobofans.hbtrip.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            HbtripAiProperties.MidjourneyProperties properties = SpringUtil.getBean(HbtripAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link HbtripAiAutoConfiguration#deepSeekChatModel(HbtripAiProperties)}
     */
    ...
    /**
     * 可参考 {@link HbtripAiAutoConfiguration#xingHuoChatClient(HbtripAiProperties)}
     */
