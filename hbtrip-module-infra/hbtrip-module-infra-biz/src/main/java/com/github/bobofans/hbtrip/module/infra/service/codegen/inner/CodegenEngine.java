package com.github.bobofans.hbtrip.module.infra.service.codegen.inner;
...
import com.github.bobofans.hbtrip.framework.apilog.core.enums.OperateTypeEnum;
...
import com.github.bobofans.hbtrip.framework.common.util.date.LocalDateTimeUtils;
...
import com.github.bobofans.hbtrip.framework.excel.core.annotations.DictFormat;
import com.github.bobofans.hbtrip.framework.excel.core.convert.DictConvert;
...
import com.github.bobofans.hbtrip.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "hbtrip-module-${table.moduleName}/" + // 顶级模块
                "hbtrip-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "hbtrip-module-${table.moduleName}/" + // 顶级模块
                "hbtrip-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "hbtrip-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "hbtrip-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
